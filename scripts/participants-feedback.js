...
var outputFilepath = 'feedback/feedback-participants-0-12.csv';
var fs = require('fs');
...
stream.once('open', function(fd) {
   stream.writeUserHeaders(["interfaceFeedback", "generalFeedback"])
   ...
   mturk.forEach(function(user) {
      ...
      stream.writeUserLine(user, ['"' + user.questionnaires.preference.feedback + '"', '"' + user.questionnaires.additionalFeedback + '"'])
   });
